/*
  ...
  - The values [permissions.get-user-by-search-query] on the enum `UserPermissions` will be removed. If these variants are still used in the database, this will fail.
