...
ALTER TYPE "UserPermissions" ADD VALUE 'permissions.create-new-ticket';
ALTER TYPE "UserPermissions" ADD VALUE 'permissions.update-ticket-status';
ALTER TYPE "UserPermissions" ADD VALUE 'permissions.update-ticket-holder-credentials';
